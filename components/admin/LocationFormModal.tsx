    ...
    <>
      <div className="fixed inset-0 z-[160] overflow-hidden flex items-center justify-end">
        ...
        <div className="relative h-full w-full max-w-xl bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
          ...
          <form onSubmit={handleFormSubmit} className="flex-1 p-6 md:p-8 space-y-8 overflow-y-auto text-left">
      ...
      {isConfirmingSave && (
        <ConfirmationModal
          title="Save Location?"
          message={`Are you sure you want to save the area infrastructure for "${formData.name}"?`}
