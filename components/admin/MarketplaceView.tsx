        ...
        {!isEnabled ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map(p => (
              <div key={p.id} className="bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm group hover:shadow-md transition-all flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="mt-2 flex flex-wrap gap-1">
                    {p.sizeStocks?.map(ss => (
                      <div key={ss.size} className="px-1.5 py-0.5 bg-slate-50 border border-slate-200 rounded-sm text-[8px] font-black text-slate-400 uppercase tracking-widest">
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-[9px] font-black uppercase text-slate-400 tracking-[0.2em]">
                    <div className="flex items-center gap-1.5"><Layers className="w-3 h-3" /> STOCK: {p.quantity}</div>
